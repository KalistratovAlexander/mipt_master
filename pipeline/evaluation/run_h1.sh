...
# Compares 3 model sizes: 0.6B, 1.7B, 4B (all fine-tuned with SID tokens).
# Estimated wall-clock: ~8h. Cost ~$11 at $1.34/h.
#
...
step "7/8 stat_tests 0.6B vs 1.7B" "$STAT" \
...
step "8/8 stat_tests 1.7B vs 4B" "$STAT" \
